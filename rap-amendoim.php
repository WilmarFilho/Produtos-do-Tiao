<!DOCTYPE html>
	<html>
		...
		<head lang="pt-br">
			...
			<title>Produtos do Tião - Rapadura De Amendoim </title>
				...
				<div class="row text-center">
					...
					<div class="col-md-4">
						...
						<div>
							...
							<h2 class="text-danger">Mini Rapadura do tião</h2>
							<h3 class="text-warning">Amendoim</h3>
					...
					<div class="col-md-4">
						<img src="imagens/rap2.png" class="img-fluid">
					</div>
