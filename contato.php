		...
		<body id="contato">
			...
			<section id="banner" class='container-fluid bann10 arredondamento  mx-auto py-5'>  <!-- Inicio Sessão Cachaças -->
				...
				<article class="row align-self-start ">
					...
					<form method="POST" action="controler_da_view.php" class="col-6 mx-auto text-danger">
					...
					<form method="POST" action="controler_da_view.php" class="col-6 mx-auto text-danger">
						...
						<div class="form-row">
							...
							<div class="form-group col-12">
								<label>Email:</label>
								<input class="form-control" type="text" name="nome" placeholder="Coloque seu email">
							</div>
