					...
					<form method="POST" action="" class="col-6 mx-auto text-danger">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								...
								<input class="form-control" type="text" name="nome" placeholder="Coloque o nome da sua loja">
							</div>
						</div>
						...
						<div class="form-row">
							...
							<div class="form-group col-md-5">
								<label>Imagem:</label>
								<input class="form-control" type="text" name="img_produto" placeholder="Seu endereço">
							</div>
						</div>
