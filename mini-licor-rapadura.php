<!DOCTYPE html>
	<html>
		...
		<head lang="pt-br">
			...
			<title>Produtos do Tião - Mini licor de Rapadura</title>
				...
				<div class="row text-center">
					...
					<div class="col-md-4">
						...
						<div>
							...
							<h2 class="text-danger">Mini Licor do tião no 12</h2>
							<h3 class="text-dark">Rapadura</h3>
					...
					<div class="col-md-4">
						<img src="imagens/mini-licor.png">
					</div>
					...
					<div class="col-md-4  ">
						...
						<div class="row justify-content-center">
							...
							<img src="imagens/licor/img1.jpeg" class="col-md-6">
							<img src="imagens/licor/img2.jpeg" class="col-md-6">
