					...
					<article class="row col-12 d-flex align-items-start pl-5 pt-4 mb-5" style="">
						...
						<?php if(!isset($_GET['cidade']) and !isset($_GET['nomeloja'])) { ?>
							...
							<div id='estados' class="mt-5 row w-100 d-flex justify-content-around  ">
								<span onclick="requisição('cidadesG.php')" class="banner estado p-3 m-2">Goiás</span>
								<span onclick="requisição('cidadesB.php')" class="banner estado p-3 m-2">Bahia</span>
								<span onclick="requisição('cidadesM.php')" class="banner estado p-3 m-2">Mato Grosso</span>
							</div>
						<?php  } ?>
						...
						<div class="animacao row justify-content-around mt-5">
							...
							<?php if(isset($_GET['cidade']) or isset($_GET['nomeloja'])) { ?>
								...
								<div class="col- 11 col-md-5 m-1 card arredondamento class-card" style="">
								  <img class="pt-2 card-img-top arredondamento " src="<?=$loja->img?>"  alt="">
								  <div class="card-body">
								    <h5 class="card-title h3 text-danger text-center"><?= $loja->nome ?></h5>
								    <p class="card-text"><?= $loja->endereço ?></p>
