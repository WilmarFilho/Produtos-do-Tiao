<!DOCTYPE html>
	<html>
		...
		<head lang="pt-br">
			...
			<title>Produtos do Tião - Caninha do Tião Prata</title>
				...
				<div class="row text-center">
					...
					<div class="col-md-4">
						...
						<div>
							...
							<h2 class="text-danger">Caninha do tião no 12</h2>
					...
					<div class="col-md-4  ">
						...
						<div class="row justify-content-center">
							...
							<img src="imagens/pinga/img1.jpeg" class="col-md-6">
							<img src="imagens/pinga/img2.jpeg" class="col-md-6">
							<img src="imagens/pinga/img3.jpeg" class="mt-2 col-md-6">
